...
const Forgotpass = () => {
  ...
  return (
    ...
    >
        ...
        <div style={{fontFamily:"Roboto condensed", padding:"40px", fontSize:"18px",marginBottom:"-50px",color:'white'}}><p>
          ...
          <p style={{color:'white'}}><span style={{color:"red"}}>*</span> Email</p>
            <TextField
                      className="textfields"
              style={{ margin: "10px 10px 10px 0" ,backgroundColor:'white',borderRadius:'5px' }}
              name="email"
